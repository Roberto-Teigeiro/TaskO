    ...
    <div className="h-screen w-screen flex flex-row overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center p-10 max-w-xl transition-all duration-500 group-hover:scale-110">
            <div className="mb-6 mx-auto">
              <svg className="w-20 h-20 mx-auto text-indigo-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"></path>
              </svg>
            </div>
            <h2 className="text-4xl font-bold text-indigo-800 mb-6">Join a Project</h2>
            <p className="text-xl text-indigo-700">Collaborate with others on exciting projects that match your skills and interests.</p>
            <div className="mt-8">
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center p-10 max-w-xl transition-all duration-500 group-hover:scale-110">
            <div className="mb-6 mx-auto">
              <svg className="w-20 h-20 mx-auto text-purple-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clipRule="evenodd"></path>
              </svg>
            </div>
            <h2 className="text-4xl font-bold text-purple-800 mb-6">Create a Project</h2>
            <p className="text-xl text-purple-700">Launch your own project and bring your ideas to life with a team of collaborators.</p>
            <div className="mt-8">
      ...
      {showJoinProjectModal && (
        ...
        >
          ...
          >
            ...
            <div className="p-6">
              <h2 className="text-2xl font-bold text-indigo-800 mb-4">Join a Project</h2>
              <p className="text-gray-600 mb-6">This feature is coming soon. Check back later!</p>
            </div>
          </div>
        </div>
      )}
